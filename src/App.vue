...
-->`,
  ...
  computed: {
    data_5() {
      return `${this.data_5_1} * ${this.data_5_2}`;
    },
  },
  methods: {
    // dragging
    draggingCol(data) {
      ...
      this.data_1 = value + "%";
      this.data_1_1 = 100 - value + "%";
    },
    draggingRow(data) {
      const value = parseInt(data);
      this.data_2 = value + "%";
      this.data_2_1 = 100 - value + "%";
    },
    resizingCol(data) {
      this.data_3 = data + "px";
    },
    ...
    resizingC(data) {
      this.data_5_1 = data + "px";
    },
    resizingR(data) {
      this.data_5_2 = data + "px";
    },
    isDragging(data) {
